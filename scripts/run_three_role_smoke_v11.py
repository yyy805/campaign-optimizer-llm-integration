"""Run v11 bounded Reviewer-retry smoke; add --real only intentionally."""
...
def main():
    ...
    result = ThreeRoleRunnerV11().run(request=request, plan=load("final_plan.demo.json"), review=load("ontology_review.demo.json"), context=load("llm_context.demo.json"), question=args.question, revision_profile=args.profile, dry_run=not args.real)
