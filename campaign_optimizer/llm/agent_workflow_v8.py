"""v8 configuration loader for the pinned Executor v4 mapping prompt."""
...
CONFIG = Path(__file__).with_name("agent_roles.v8.json")
...
def load_role_configuration(path: Path = CONFIG) -> RoleConfigurationV7:
    ...
    if raw.get("schema_version") != "1.0" or raw.get("configuration_version") != "agent_roles_v8":
